C  This function has been taken from the R package statmod (version 1.4.36) 
C  on June 5, 2022. The reference for the package is: Giner G, Smyth GK (2016).
C  statmod: probability calculations for the inverse Gaussian distribution. 
C  R Journal, 8(1), 339-351. 
