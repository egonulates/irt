...
test_that("Test setValidity of 'Testlet' class", {
  ...
  expect_s4_class(object = new("Testlet", item_list = itempool(item4, item5)),
                  class = "Testlet")
  expect_s4_class(object = new("Testlet", item_list = itempool(item4)),
                  class = "Testlet")
